...
**Remaining before `[x]`:** production dormant-schema restart, empty-table assertion, exact masked 25-user/71-device pre/post gate and legacy smoke. PH3-03 must not start automatically.
